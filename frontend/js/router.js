...
function renderMenu() {
  ...
  if (session.role === 'admin') {
    items.push(
      { id: 'dashboard', icon: 'fa-chart-line', label: 'ภาพรวมการดำเนินงาน' },
      { id: 'organizations', icon: 'fa-building', label: 'การบริหารจัดการหน่วยงาน' },
      { id: 'users', icon: 'fa-key', label: 'การจัดการรหัส PIN หน่วยงาน' },
      { id: 'projects', icon: 'fa-tasks', label: 'การบริหารจัดการโครงการ' },
      { id: 'audit-log', icon: 'fa-list-alt', label: 'ประวัติการใช้งานระบบ' }
    );
  } 
    ...
    items.push(
      { id: 'dashboard', icon: 'fa-chart-line', label: 'ภาพรวมการดำเนินงาน' },
      { id: 'projects-all', icon: 'fa-globe', label: 'บัญชีรายละเอียดโครงการ' },
      { id: 'projects', icon: 'fa-tasks', label: 'การบริหารจัดการโครงการ' },
      { id: 'organizations-view', icon: 'fa-building', label: 'บัญชีรายชื่อหน่วยงาน' }
    );
  }
