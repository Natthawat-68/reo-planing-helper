...
function exportCSV() {
  ...
  const COLUMNS = [
    ...
    { id: 'imageCount', label: 'url (ภาพกิจกรรม 3-4 ภาพ)', defaultSelected: true, get: (p) => imageCountOf(p) },
    ...
    { id: 'imageCount2', label: 'จำนวนรูป', defaultSelected: false, get: (p) => imageCountOf(p) },
